              ...
              <div className="prose prose-sm max-w-none dark:prose-invert">
                {activeTab === "terms" ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">PLEASE READ THESE TERMS OF USE ("AGREEMENT" OR "TERMS OF USE" or "TERMS OF SERVICE" or "TERMS AND CONDITIONS") CAREFULLY BEFORE USING THE SERVICES OFFERED BY Iris AI Corp (Patiala, Punjab, India). THIS AGREEMENT SETS FORTH THE LEGALLY BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE IRIS WEBSITE AND ALL RELATED SERVICES.</p>

                    <h3 className="text-lg font-medium tracking-tight">Definitions</h3>
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>"Company" refers to Iris AI Corp (Patiala, Punjab, India).</li>
                      <li>"Site" refers to the Iris website, including any related features, content, or applications offered from time to time by the Company.</li>
                      <li>"Service" refers to the Iris website and all related services provided by the Company, including the AI‑powered agent that helps you accomplish real‑world tasks.</li>
                      ...
                      <li>"Notice Address" refers to the contact address for the Company, specifically legal@irisai.vision</li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">The Company utilizes artificial intelligence systems to generate content and perform actions. Such generation may unintentionally involve copyrighted material or trademarks held by others. We respect rights holders internationally, and we ask our users to do the same. If you believe your copyright or trademark is being infringed by the Service, please write to legal@irisai.vision and we will process and investigate your request and take appropriate actions under the Digital Millennium Copyright Act and other applicable intellectual property laws with respect to any alleged or actual infringement.</p>

                    <h3 className="text-lg font-medium tracking-tight">Fees and Payments</h3>
                    <p className="text-muted-foreground text-balance mb-4">The Company may offer paid Services. You can learn more about our pricing after signing up. You may sign up for a subscription, payable in Indian rupees, that will automatically renew. You can stop using the Service and cancel your subscription at any time through the website or by emailing us at legal@irisai.vision. If you cancel your subscription, you may not receive a refund or credit for any amounts that have already been billed or paid. The Company reserves the right to change its prices at any time. If you are on a subscription plan, changes to pricing will not apply until your next renewal.</p>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">For questions regarding the Service, you can get in touch by emailing us at <a href="mailto:legal@irisai.vision" className="text-secondary hover:underline">legal@irisai.vision</a>.</p>
                  </div>
                ) : (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">References to our "Services" at Iris in this statement include our website, apps, and other products and services. This statement applies to our Services that display or reference this Privacy Statement. Third‑party services that we integrate with are governed under their own privacy policies.</p>

                    <p className="text-muted-foreground text-balance mb-6">Iris does not collect biometric or identifying information. All data is processed securely and any data is deleted upon account removal.</p>
                    ...
                    <h3 className="text-lg font-medium tracking-tight">Contact Us</h3>
                    <p className="text-muted-foreground text-balance">You can get in touch by emailing us at <a href="mailto:legal@irisai.vision" className="text-secondary hover:underline">legal@irisai.vision</a>.</p>
                  </div>
                )}
              </div>
            </div>
