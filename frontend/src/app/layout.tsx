...
export const metadata: Metadata = {
  ...
  // Update the canonical website to the Iris domain.
  authors: [{ name: "Iris Team", url: "https://irisai.vision" }],
  creator: "Iris Team",
  publisher: "Iris Team",
  category: "Technology",
  ...
  openGraph: {
    ...
    description: "Iris is a fully open source AI assistant that helps you accomplish real‑world tasks with ease through natural conversation.",
    url: siteConfig.url,
    siteName: "Iris",
    images: [
      {
