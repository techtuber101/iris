...
// 🔥 Master toggle to enable/disable Billing Modal
const SHOW_BILLING_MODAL = false; // change to true to display
...
export function BillingErrorAlert({
  ...
  // Disabled window logic — just a safe default
  const returnUrl = "";

  // Hide if not open OR globally disabled
  if (!isOpen || !SHOW_BILLING_MODAL) return null;
