...
export function GenericToolView({ 
  ...
  const displayToolContent = !isSuccess && !isStreaming
    ? 'Oops — an Iris error occurred. Please try again.'
          ...
          <div className="space-y-1.5 mt-4">
            ...
            <div className={cn(
              ...
              {isStreaming ? (
                ...
                <Markdown className="text-xs text-zinc-800 dark:text-zinc-300">{displayToolContent}</Markdown>
              )}
            </div>
          </div>
        )}
