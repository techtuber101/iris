...
export function CommandToolView({ 
  ...
  const command = rawCommand
    // Remove the Iris prompt prefix from the extracted command.  This makes
    // it easier to display the user-entered command without the shell prefix.
              ...
              {command && output && !isStreaming && (
                <div className="space-y-2">
                  <div className="flex items-start">
                    <span className="text-emerald-400 shrink-0 mr-2">iris@computer:~$</span>
                  ...
                  {isSuccess && <div className="text-emerald-400 mt-1">iris@computer:~$ _</div>}
                </div>
              )}
