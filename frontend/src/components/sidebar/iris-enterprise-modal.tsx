...
// IrisProcessModal provides an enterprise demo modal for Iris.  It was
// previously branded for Kortix; this version removes all Kortix names
// and uses the Iris branding and domain instead.  Note: this modal is
// currently not used in the sidebar but is kept for potential future
// enterprise demos.
export function IrisProcessModal() {
