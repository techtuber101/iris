...
def read_master_config():
    ...
    if not master_file.exists():
        print("❌ env.config.master file not found!")
        return None
...
def generate_frontend_env(config, env_mode):
    ...
    if env_mode == 'production':
        frontend_env.append("NEXT_PUBLIC_BACKEND_URL=https://irisvision.ai")
...
def main():
    ...
    print("🚀 Iris AI Environment Configuration Generator")
    print("=" * 50)
    ...
    print(f"🌍 Current environment: {env_mode.upper()}")
